...
export class GithubService {
  ...
  getBranches(username: string, repoName: string): Observable<GitHubBranch[]> {
    return this.http.get<GitHubBranch[]>(`${this.baseUrl}/repos/${username}/${repoName}/branches`, {
      headers: this.getHeaders(),
    });
  }
  ...
  ): Observable<GitHubTreeItem[]> {
    const url = `${this.baseUrl}/repos/${username}/${repoName}/git/trees/${branch}${
